...
import com.dumbapp.destinyclassscanner.databinding.FragmentCameraBinding;
...
public class CameraFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ((DCSApplication) requireContext().getApplicationContext()).getDCSApplicationComponent().inject(this);
